      ...
      <div className="flex flex-wrap justify-items-center bg-gray-200">
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member1"
              src="img/members/maya.jpg"
              onClick={() =>
                document.getElementById("membersModal1").showModal()
              }
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member2"
              src="img/members/amanda.jpg"
              onClick={() =>
                document.getElementById("membersModal2").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member3"
              src="img/members/alex.jpg"
              onClick={() =>
                document.getElementById("membersModal3").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member1"
              src="img/members/bhaskar.jpg"
              onClick={() =>
                document.getElementById("membersModal4").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member2"
              src="img/members/ellington.jpg"
              onClick={() =>
                document.getElementById("membersModal5").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member3"
              src="img/members/justin.jpg"
              onClick={() =>
                document.getElementById("membersModal6").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member1"
              src="img/members/jerry.jpg"
              onClick={() =>
                document.getElementById("membersModal7").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member2"
              src="img/members/athena.jpg"
              onClick={() =>
                document.getElementById("membersModal8").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member3"
              src="img/members/stephanus.jpg"
              onClick={() =>
                document.getElementById("membersModal9").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member1"
              src="img/members/kian.jpg"
              onClick={() =>
                document.getElementById("membersModal10").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member2"
              src="img/members/eddie.jpg"
              onClick={() =>
                document.getElementById("membersModal11").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member3"
              src="img/members/andrew.jpg"
              onClick={() =>
                document.getElementById("membersModal12").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member1"
              src="img/members/ethan.jpg"
              onClick={() =>
                document.getElementById("membersModal13").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member2"
              src="img/members/tom.jpg"
              onClick={() =>
                document.getElementById("membersModal14").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member3"
              src="img/members/madlen.jpg"
              onClick={() =>
                document.getElementById("membersModal15").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
        ...
        <div className="w-1/3 grid place-items-center justify-center items-center mt-4">
          <div>
            <img
              id="member1"
              src="img/members/christopher.jpg"
              onClick={() =>
                document.getElementById("membersModal16").showModal()
              }
              className="max-w-sm h-auto"
            />
          </div>
