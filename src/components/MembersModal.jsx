const MembersModal = ({ memberId }) => {
  const members = [
    {},
    {
      ...
      Nsemster: "2nd",
      interests:
        "t1s, poke parlor before they removed the party discount, nilah sejuani, r/dataisbeautiful, tartaglia, peets coffee, open toed shoes, and my BRITA",
    ...
    },
    {
      ...
      Nsemster: "2nd",
      interests:
        "bees, movies, b-movies, making media comm regret not putting a word limit for bio",
    ...
    },
    {
      ...
      Nsemster: "3rd",
      interests:
        "Singing, gaming, complaining, no longer cyberbullying the managers on discord since they started posting in announcements! We love progress!",
    ...
    },
    {
      ...
      voicePart: "Baritone",
      Majorminor:
        "In order from favorite to least favorite I'd probably go C,G,E♭, B, F#, D♭, A♭,A,A#... Take with that as you will. If I missed on of your favorites let me know in the comments below!",
      Bsemster: "4th",
      Nsemster: "4th",
      interests:
        "In order from most to least favourite I'd have to go tech, pharmaceuticals, consumer staples, materials, real estate, government bonds, APY, debt, and crypto. Wait no, switch debt and crypto. Yeah, yeah, that looks better. Hey what ever happened to NFTs?",
    ...
    },
    {
      ...
      Nsemster: "3rd",
      interests:
        "Video Games, uhhhhhhh, Acapella, uhhhhhhhhh, Working Out, uhh oh and Acting",
    ...
    },
    {
      ...
      Nsemster: "2nd",
      interests:
        "crochet, machine girl, laoganma, kim kitsuragi, chemistry, daniel radcliffe's left ear, crustacean, steamed hams",
    ...
    },
    {
      ...
      Nsemster: "2nd",
      interests:
        "my girlfriend, kpop, gym, premed, cookie run kingdom, webtoons, birds aren't real",
    ...
    },
    {
      ...
      Nsemster: "6th",
      interests:
        "Being Albanian, Olive Oil, Gipsy Kings, Outer Wilds, Jon Bois, Two Words",
    ...
    },
    {
      ...
      Nsemster: "4th",
      interests:
        "Stephanus Yang, Evan Yang, Evanus Yang, Stephie, Steph Anus, Steph, Mr. President, My President 👨‍❤️‍💋‍👨, Steph Curry",
    ...
    },
    {
      ...
      voicePart: "Bass",
      Majorminor:
        "Undeclared (Intended Applied Math) (questionable on the intended part)",
      Bsemster: "2nd",
      Nsemster: "1st",
      interests:
        "lore dumps in presentation format, listening to the same song for an entire day, telling myself I will start that new show today, being Korean, laughing to hide the fact that I didn’t hear you, pooja what is this behavior, stan loona for clearer skin",
    ...
    },
    {
      ...
      Nsemster: "4th",
      interests:
        "sports, working out, going flat, fixed interest, compound interest, playing video games, being sober at parties, kian chou, ellington chen, eddie cekici, bari sectionals, WEEEEEEEEEEEEEHHHHH ",
    ...
    },
    {
      ...
      Nsemster: "1st",
      interests:
        "singing, cooking, reading, writing, being Armenian, plotting the demise of my enemies, ending things on a cliffhanger, Sherlock Holmes, solving escape room puzzles",
  ...
  return (
    <dialog id={Id} className="modal">
      <div className="modal-box">
        <div className="flex justify-center items-center bg-base-200 hero">
          <div className="fade-in hero-content flex-col px-[15%]">
            <img
              src={Photo}
            ...
            <div>
              ...
              <ul className="list-disc word-break:break-all">
                ...
                <li>
                  <b>Semester in Berkeley: </b>
                  {member.Bsemster}
                </li>
                <li>
                  <b>Semester in Noteworthy: </b>
                  {member.Nsemster}
                </li>
                <li>
                  <b>Interests: </b>
                ...
                <li className="work-break:break-all">
                  <b>Bio: </b>
                  {member.bio}
                </li>
              </ul>
